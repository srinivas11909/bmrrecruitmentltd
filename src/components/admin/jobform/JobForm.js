       ...
       <div className="border shadow-sm rounded-lg p-4">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-3">
            ...
            <input type="text" placeholder="Enter job title" className="rounded-md border px-3 py-2 text-base w-full" name="title" {...register("title",{required: true, maxLength: 80})}/>
            {errors.title && <span className="text-red-500">Job title is required</span>}
          </div>
          <div className="mb-3">
            <label htmlFor="desc" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Add Job Description</label>
            <TextEditor className="" name="desc" onContentChange={handleEditorChange}/>
          </div>
          <div className="mb-3">
            <label htmlFor="locations" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-4">Select Location</label>
            <select id="locations" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="locations" {...register("locations",{required: true})}  defaultValue={"Choose a country"}>
           ...
           {errors.locations && <span className="text-red-500">Select location</span>}
          ...
          {errors.jobType && <span lassName="text-red-500">Select Job type</span>}
          </div>
